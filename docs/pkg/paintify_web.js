/* @ts-self-types="./paintify_web.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function paintify_default_js(input_data) {
    const ptr0 = passArray8ToWasm0(input_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.paintify_default_js(ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('paintify_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
